...
$BACKEND_RG_NAME = "rg-qa-terraform-mgmt"
$LOCATION = "eastus" # Update this to your preferred region (e.g., westeurope, centralus)
$STORAGE_ACCOUNT_NAME = "stqatfstate2026" # MUST BE UNIQUE globally across all of Azure (lowercase + numbers only, 3-24 chars)
